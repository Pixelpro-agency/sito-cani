    ...
    <section className='py-12 lg:py-24'>
      <div className='container mx-auto'>
        <div className='text-center mb-20'>
          <div className='text-orange font-semibold mb-3'>i nostri Prezzi</div>
          <h2 className='h2 mb-3'>Quanto è grande il tuo cane?</h2>
          <p className='text-lg text-blue'>Scegli la categoria</p>
        </div>
        {/* bundles */}
